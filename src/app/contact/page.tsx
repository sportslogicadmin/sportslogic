  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <h1 className="font-heading text-2xl font-bold uppercase text-text-primary mb-4">Get In Touch</h1>
        <p className="text-sm text-text-secondary max-w-[400px] leading-relaxed mb-6">
          Questions, feedback, or partnership inquiries — reach us at:
        </p>
        <a
          href="mailto:hello@sportslogic.ai"
          className="text-accent text-sm hover:brightness-110 transition-all"
        >
